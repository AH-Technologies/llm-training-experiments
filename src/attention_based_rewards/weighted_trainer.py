...
def _compute_token_weights(data) -> torch.Tensor | None:
    ...
    """
    from attention_based_rewards.token_weighting import (
...
def _get_fai_weights(data) -> torch.Tensor:
    ...
    from attention_based_rewards.token_weighting import compute_fai_weights
...
def _get_fai_allheads_weights(data) -> torch.Tensor:
    ...
    _weight_log("WARNING: _precomputed_fai_weights not found, falling back to local computation")
    from attention_based_rewards.token_weighting import compute_fai_weights_allheads
...
def _get_attention_weights(data) -> torch.Tensor:
    ...
    # Fallback: compute locally
    _weight_log("WARNING: _precomputed_fai_weights not found, falling back to local computation")
    from attention_based_rewards.token_weighting import compute_attention_weights
...
def _compute_anchor_credit_local(data) -> torch.Tensor:
    ...
    from attention_based_rewards.token_weighting import compute_anchor_credit_weights
