...
def apply_rhythm_weights(data) -> object:
    ...
    if weighting_method == "fai_asymmetric":
        from attention_sparks_thinking.token_weighting import compute_asymmetric_weights
...
def _compute_eapig_gammas_on_worker(
    ...
    """
    from attention_sparks_thinking.token_weighting import (
...
def reclassify_heads_on_worker(eager_model, tokenizer, step, log_fn=None):
    ...
    """
    from attention_sparks_thinking.head_classifier import classify_heads as _classify
