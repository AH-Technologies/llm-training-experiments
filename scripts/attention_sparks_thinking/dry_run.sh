...
#   bash scripts/attention_sparks_thinking/dry_run.sh
#
# Or via SLURM:
#   sbatch scripts/attention_sparks_thinking/slurm/dry_run.slurm
...
python scripts/attention_sparks_thinking/prepare_data.py
