...
#
# Usage:
#   bash scripts/attention_sparks_thinking/run_condition.sh A   # baseline
#   bash scripts/attention_sparks_thinking/run_condition.sh B   # static rhythm
#   bash scripts/attention_sparks_thinking/run_condition.sh C   # adaptive rhythm
#
...
python3 scripts/attention_sparks_thinking/train.py \
    ${CUSTOM_ARGS} \
