...
Usage:
    ...
    python scripts/self_teach/prepare_dapo_self_teach.py --max-problems 5000
    python scripts/self_teach/prepare_dapo_self_teach.py --test-fraction 0.1
"""
