...
Usage:
    python scripts/filter_bigmath_by_eval.py
    python scripts/filter_bigmath_by_eval.py --min-solve-rate 0.0 --max-solve-rate 0.5
    python scripts/filter_bigmath_by_eval.py --eval-results data/bigmath/eval_results_k8_shard0.json data/bigmath/eval_results_k8_shard1.json
"""
