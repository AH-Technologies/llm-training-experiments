...
Usage:
    python scripts/s1/prepare_s1k_self_teach.py
    python scripts/s1/prepare_s1k_self_teach.py --train data/s1K/s1k_train.parquet --test data/s1K/s1k_test.parquet
"""
