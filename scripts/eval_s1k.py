...
Usage:
    python scripts/eval_s1k.py [OPTIONS]

Examples:
    python scripts/eval_s1k.py                          # defaults: Qwen3-1.7B, k=1
    python scripts/eval_s1k.py --k 4 --temperature 0.7
    python scripts/eval_s1k.py --model path/to/checkpoint --k 8
"""
