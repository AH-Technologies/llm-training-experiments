...
Usage:
    python scripts/prepare_bigmath_self_teach.py
    python scripts/prepare_bigmath_self_teach.py --min-solve-rate 0 --max-solve-rate 0.4
    python scripts/prepare_bigmath_self_teach.py --max-problems 10000
"""
