...
#
# Usage:
#   bash scripts/attention_based_rewards/run_dapo_condition.sh uniform
#   bash scripts/attention_based_rewards/run_dapo_condition.sh entropy
#   bash scripts/attention_based_rewards/run_dapo_condition.sh fai_allheads
#   bash scripts/attention_based_rewards/run_dapo_condition.sh fai
#   bash scripts/attention_based_rewards/run_dapo_condition.sh fai_asymmetric
#
...
REASONING_HEADS_PATH=${REASONING_HEADS_PATH:-"results/attention_based_rewards/reasoning_heads.pt"}
case "${CONDITION}" in
