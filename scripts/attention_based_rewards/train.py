...
Usage:
  python scripts/attention_based_rewards/train.py \
    --condition uniform \
    [verl hydra overrides...]

  python scripts/attention_based_rewards/train.py \
    --condition attention \
    --reasoning_heads results/attention_based_rewards/reasoning_heads.pt \
...
def main():
    ...
    if args.suffix_mode == "random":
        from attention_based_rewards.suffix_patch import apply_random_suffix_patch
    ...
    from attention_based_rewards.weighted_trainer import apply_patches
