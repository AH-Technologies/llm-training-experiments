...
#
# Usage:
#   bash scripts/attention_based_rewards/run_condition.sh uniform
#   bash scripts/attention_based_rewards/run_condition.sh attention
#   bash scripts/attention_based_rewards/run_condition.sh entropy
#   bash scripts/attention_based_rewards/run_condition.sh combined
#
...
case "${CONDITION}" in
    attention|combined|fai|asymmetric)
        CUSTOM_ARGS="${CUSTOM_ARGS} --reasoning_heads results/attention_based_rewards/reasoning_heads.pt --top_k_heads 10"
        ;;
    attention_top5)
        CUSTOM_ARGS="${CUSTOM_ARGS} --reasoning_heads results/attention_based_rewards/reasoning_heads.pt --top_k_heads 5"
        ;;
esac
...
python3 scripts/attention_based_rewards/train.py \
    ${CUSTOM_ARGS} \
