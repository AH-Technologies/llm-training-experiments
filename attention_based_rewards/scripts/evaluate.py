...
Usage:
  python attention_based_rewards/scripts/evaluate.py \
    --checkpoint_dir outputs/ \
    --conditions uniform attention entropy combined \
    --output_dir attention_based_rewards/results/evaluation
"""
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="attention_based_rewards/results/evaluation")
