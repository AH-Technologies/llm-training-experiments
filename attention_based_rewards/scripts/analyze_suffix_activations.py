...
Usage:
  sbatch attention_based_rewards/slurm/analyze_suffix_activations.slurm
"""
...
from attention_based_rewards.scripts.suffix_patch import SUFFIXES as RANDOM_SUFFIXES
